    ...
    <div class="create-event bg-[#0B0D19]">
      <div class="create-event-container max-w-md md:max-w-3xl lg:max-w-4xl xl:max-w-6xl mx-auto rounded-[0.25rem] py-[3vh] px-[3vh]">
        ...
        <div class="create-event-body bg-[#EFEFEF] p-[1.25rem]">
          <p class="text-center mb-4">Cambie la informacion que desee y luego aplique los cambios con el boton de "Guardar Cambios" que se encuentra al final del formulario.</p>
          <form method="POST" action="{{route('store-event')}}" enctype="multipart/form-data">
            @csrf
            {{-- Nombre --}}
            <p class="text-3xl text-red-600">Falta el event-store para tener la accion de crear evento y create-event para tener lo de los coorganizadores y arreglos no pusheados en dev</p>
            <div class="mb-4">
