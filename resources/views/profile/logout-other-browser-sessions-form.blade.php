<x-jet-action-section>
    ...
    <x-slot name="content">
        <div class="max-w-xl text-sm text-gray-600">
            {{ __('Si lo necesita, usted puede cerrar sesión de todos los navegadores en todos sus dispositivos. Algunas de las sesiones más recientes están listadas abajo; aunque, esta lista no es exhaustiva. Si siente que su cuenta está comprometida, usted debería cambiar su contraseña también.') }}
        </div>
        ...
        <x-jet-dialog-modal wire:model="confirmingLogout">
            ...
            <x-slot name="content">
                {{ __('Por favor ingrese su contraseña para confirmar que quiere cerrar sesión de todos los navegadores en todos sus dispositivos.') }}
