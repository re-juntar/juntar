<div class="flex flex-col justify-center items-center">
    @if (array_key_exists('image', $miembro))
        <img src={{asset('/images/about-us/'.$miembro['image'].'.png')}} alt="{{ $miembro['name'] }}" class="w-8/12 rounded-full">
    @else
        <img src={{asset('/images/about-us/Portrait_Placeholder.png')}} alt="{{ $miembro['name'] }}" class="w-8/12 rounded-full">
    @endif
    <div>
