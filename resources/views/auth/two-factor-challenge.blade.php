    ...
    <x-jet-authentication-card>
        ...
        <div x-data="{ recovery: false }">
            <div class="mb-4 text-sm text-gray-600" x-show="! recovery">
                {{ __('Por favor confirme acceso a su cuenta ingresando el código de autenticación provisto por su aplicación de autenticación.') }}
            </div>

            <div class="mb-4 text-sm text-gray-600" x-show="recovery">
                {{ __('Por favor confirme acceso a su cuenta ingresando uno de sus códigos de recuperación de emergencia.') }}
            </div>
